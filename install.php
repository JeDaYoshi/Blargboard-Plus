	...
	<div class="container">
		<div class="outline">
			...
			<div class="box cell center">
				The Blargboard Plus installation was successful. You may now <a href="./?page=login">proceed to your board and login</a>. Thanks for choosing Blargboard Plus!<br><br><a href="http://tierage.net/board">Click here</a> to go to the Blargboard Plus DevBoard to learn more about Blargboard Plus.
			</div>
		</div>
	</div>
<?php
